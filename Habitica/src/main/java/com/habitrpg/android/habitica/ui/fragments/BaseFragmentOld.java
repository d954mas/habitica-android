...
import com.habitrpg.android.habitica.ui.activities.BaseActivityOld;
...
public abstract class BaseFragmentOld extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        injectFragment(((BaseActivityOld) getActivity()).getHabiticaApplication().getComponent());
    }
